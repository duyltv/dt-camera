...
This page contains the detailed technical setup notes, API examples, database
commands, and operational references that used to live in the project README.

License note: DT Camera is source-available for personal and small
non-commercial use. Commercial use requires permission from Duy Nguyen
(duyltv). See `LICENSE`.
